  ...
  return (
    ...
    >
      ...
      <ul>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to W and K Technology, accessible
            from{' '}
            <a
              href='https://www.wandktech.com'
              rel='external nofollow noopener noreferrer'
              target='_blank'
            >
              https://www.wandktech.com
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>
          <p>By email: support@wandktech.com</p>
        </li>
        <li>
          <p>
            By mail: 15-2714 Pahoa Village Rd #336, Pahoa HI 96778, United
            States
          </p>
        </li>
      </ul>
